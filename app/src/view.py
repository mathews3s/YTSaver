...
# Form implementation generated from reading ui file 'UI-ST0.ui'
#
...
class View():
    ...
    def setupMainWindow(self):
        ...
        self.MainWindow.resize(1010, 730) ###
        self.sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        self.sizePolicy.setHorizontalStretch(0)
        self.sizePolicy.setVerticalStretch(0)
        self.sizePolicy.setHeightForWidth(self.MainWindow.sizePolicy().hasHeightForWidth()) ###
        self.MainWindow.setSizePolicy(self.sizePolicy) ###
        self.MainWindow.setMinimumSize(QtCore.QSize(1010, 730)) ###
        self.MainWindow.setMaximumSize(QtCore.QSize(1010, 730)) ###

        self.MainWindow.setStyleSheet("border-color: rgb(255, 16, 80);") ###
        self.WorkSpace = QtWidgets.QWidget(self.MainWindow) ###
...
"")
        ...
        self.VTV_AddVideoButton = QtWidgets.QPushButton(self.VT_VideosContainer)
        self.VTV_AddVideoButton.setGeometry(QtCore.QRect(340, 430, 211, 31))
        self.VTV_AddVideoButton.setStyleSheet("background-color: rgb(85, 85, 127);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 10px;")
        self.VTV_AddVideoButton.setObjectName("VTV_AddVideoButton")
...
"color: rgb(255, 255, 255);")
        ...
        self.MainWindow.setCentralWidget(self.WorkSpace)

        self.retranslate(self.MainWindow)
    ...
    def retranslate(self, MainWindow):
        ...
        self.VTV_AddVideoButton.setText(_translate("MainWindow", "Add"))
